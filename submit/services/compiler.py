...
class CompilerService(object):
    ...
    def upload_package(self, pointer: FileStorage) -> ComplationStatus:
        """
    ...
    def get_upload_status(self, upload_id: int) -> ComplationStatus:
        """
    ...
    def add_file(self, upload_id: int, pointer: FileStorage,
                 ancillary: bool = False) -> ComplationStatus:
        """
...
def get_upload_status(upload_id: int) -> ComplationStatus:
...
def upload_package(pointer: FileStorage) -> ComplationStatus:
...
def delete_file(upload_id: int, file_path: str) -> ComplationStatus:
