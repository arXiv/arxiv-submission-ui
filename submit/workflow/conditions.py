...
def authorship_indicated(submission: Submission) -> bool:
...
def policy_accepted(submission: Submission) -> bool:
...
def source_processed(submission: Submission) -> bool:
    """Determine whether the submitter has compiled their upload."""
    non_processing_content=(
    ...
    return has_valid_content(submission) and \
            (submission.is_source_processed or non_processing_content)


def metadata_complete(submission: Submission) -> bool:
...
def opt_metadata_complete(submission: Submission) -> bool:
